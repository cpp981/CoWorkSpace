<template>
    <div class="container py-4">
        ...
        <GenericList :items="clientsForList" :headers="['ID', 'Nombre', 'Reservas']"
            :fields="['clientId', 'clientName', 'spaceNamesHtml']" id-key="clientId" :loading="loading"
            :show-add-button="false" :show-actions="false" :show-manage="true" @edit="habdleEdit"
